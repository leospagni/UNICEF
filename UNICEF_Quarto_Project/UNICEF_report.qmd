...
In examining global child well-being, understanding the relationship between various indicators is essential. So, it will be interesting to check if there is a solid correlation between [***child deprivation***]{style="color: skyblue"} and [***Height-for-age \<-2SD & Weight-for-height \<-2SD.***]{style="color: skyblue"}\
